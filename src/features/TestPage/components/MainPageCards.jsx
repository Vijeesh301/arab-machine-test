...
const MainPageCards = ({ selection, colorStep, setColorStep }) => {
  return (
    <>
      {selection === 0 && (
        <section className="cards-main-container">
          <section className="cards-container">
            <section className="inside-container">
              ...
              <section className="cards-button-container">
                <section className="button-container">
                  <section
                    style={{
                      backgroundColor: colorStep === 1 ? "#c9eef8" : "white",
                    }}
                  ...
                  <section
                    style={{
                      backgroundColor: colorStep === 2 ? "#c9eef8" : "white",
                    }}
                    className="button-annualy"
                    onClick={() => {
                      setColorStep(2);
                    }}
                  >
